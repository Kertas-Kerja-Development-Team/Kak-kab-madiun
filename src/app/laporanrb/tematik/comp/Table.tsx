                                ...
                                Data.map((item, index) => {
                                    ...
                                    return (
                                        <React.Fragment key={item.id ?? index}>
                                            ...
                                            <tr>
                                                {/* RB Info */}
                                                <td rowSpan={indikatorCount} className="border p-2 text-center">{index + 1}</td>
                                                <td rowSpan={indikatorCount} className="border p-2 text-center">{item.jenis_rb}</td>
                                                <td rowSpan={indikatorCount} className="border p-2 text-center">{item.kegiatan_utama}</td>
                                                ...
                                                {(() => {
                                                    ...
                                                    return (
                                                        <>
                                                            ...
                                                            <td className="border p-2 text-center">{base?.target_baseline ?? "-"}</td>
                                                            <td className="border p-2 text-center">{base?.realisasi_baseline ?? "-"}</td>
                                                            <td className="border p-2 text-center">{base?.satuan_baseline ?? "-"}</td>
                                                            <td className="border p-2 text-center">{base ? "0" : "-"}</td>
                                                            <td className="border p-2 text-center">{next?.target_next ?? "-"}</td>
                                                            <td className="border p-2 text-center">{next?.satuan_next ?? "-"}</td>
                                                        </>
                                                    );
                                                })()}
                                                ...
                                                <td rowSpan={indikatorCount} className="border p-2 text-left">
                                                    {renaksi[0]?.indikator_rencana_aksis?.map((i, idx) => (
                                                        <div key={idx}>{i.indikator}</div>
                                                    )) ?? "-"}
                                                </td>

                                                <td rowSpan={indikatorCount} className="border p-2 text-center">
                                                ...
                                                <td rowSpan={indikatorCount} className="border p-2 text-center">{renaksi[0]?.anggaran ?? "-"}</td>
                                                <td rowSpan={indikatorCount} className="border p-2 text-center">{renaksi[0]?.realisasi_anggaran ?? "-"}</td>
                                                <td rowSpan={indikatorCount} className="border p-2 text-center">{renaksi[0]?.opd_koordinator ?? "-"}</td>
                                            ...
                                            {indikator.slice(1).map((ind, indIndex) => {
                                                ...
                                                return (
                                                    <tr key={ind.id ?? indIndex}>
                                                        <td className="border p-2 text-left">{ind.indikator}</td>
